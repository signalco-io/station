...
namespace Signal.Beacon.Application.Network
{
    public class MacLookupService : IMacLookupService
    {
        ...
        public MacLookupService()
        {
            ...
            this.memoryCacheProvider = new MemoryCacheProvider(memoryCache);
            this.requestPolicy = Policy.WrapAsync(
                Policy.CacheAsync(memoryCacheProvider, TimeSpan.FromMinutes(5)),
        ...
        {
            var result = await requestPolicy.ExecuteAndCaptureAsync((context, ct) =>
